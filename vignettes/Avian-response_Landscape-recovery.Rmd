...
<!-- Add this link in the https://royalsocietypublishing.org/doi/suppl/10.1098/rspb.2019.0114 -->
...
ggplot(data=BirdSite_Data, mapping = aes(x = ln_cover, y = site.rich, color = growth)) +
  ...
  ylab(label = "Total ount per Visit")
```
...
Let's reduce species by the number found across the given sites.
